...
export default function Footer() {
    return (
        <footer className="flex justify-center w-full py-12 px-6">
            <div className="max-w-7xl">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    {/* Certifications Column */}
                    <div className="space-y-6 ">
                        <h3 className="font-semibold text-gray-800 mb-4">Certificaciones</h3>
                        ...
                        <div className="border border-gray-300 p-3 rounded">
                            <div className="flex items-center space-x-2 mb-1">
                                ...
                                <span className="font-bold text-sm">THE CLIMATE LABEL</span>
                            </div>
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    <p className="font-bold text-sm">SCIENCE BASED</p>
                                    <p className="font-bold text-sm">TARGETS</p>
                                </div>
                            </div>
                            <p className="text-xs text-gray-600 uppercase">driving ambitious corporate climate action</p>
                        </div>
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <div>
                                <p className="font-bold text-sm text-green-700">Restorative</p>
                                <p className="font-bold text-sm text-green-700">Coalition</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-600">
                            ...
                            <li><a href="#" className="hover:text-gray-800">centro de ayuda</a></li>
                            <li><a href="#" className="hover:text-gray-800">envíos</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-600">
                            <li><a href="#" className="hover:text-gray-800">localizador de tiendas</a></li>
                            <li><a href="#" className="hover:text-gray-800">guía de tallas</a></li>
                    ...
                    {/* Connected Column */}
                    <div>
                        <h3 className="font-semibold text-gray-800 mb-4">Conectado</h3>
                        <div className="mb-4">
                            ...
                            <button className="w-full bg-green-600 text-white py-2 px-4 rounded mt-4 text-sm hover:bg-green-700 transition-colors">
                                Suscribirme →
                            </button>
                        </div>
                ...
                <div className="flex justify-center items-center space-x-4 mt-18 mb-6">
                    ...
                    />
                    <div className="">
                        <svg className="w-14 h-auto pr-2 mt-2 space-y-2" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" role="img" width="38" height="24" aria-labelledby="pi-visa"><title id="pi-visa">Visa</title><path opacity=".07" d="M35 0H3C1.3 0 0 1.3 0 3v18c0 1.7 1.4 3 3 3h32c1.7 0 3-1.3 3-3V3c0-1.7-1.4-3-3-3z"></path><path fill="#fff" d="M35 1c1.1 0 2 .9 2 2v18c0 1.1-.9 2-2 2H3c-1.1 0-2-.9-2-2V3c0-1.1.9-2 2-2h32"></path><path d="M28.3 10.1H28c-.4 1-.7 1.5-1 3h1.9c-.3-1.5-.3-2.2-.6-3zm2.9 5.9h-1.7c-.1 0-.1 0-.2-.1l-.2-.9-.1-.2h-2.4c-.1 0-.2 0-.2.2l-.3.9c0 .1-.1.1-.1.1h-2.1l.2-.5L27 8.7c0-.5.3-.7.8-.7h1.5c.1 0 .2 0 .2.2l1.4 6.5c.1.4.2.7.2 1.1.1.1.1.1.1.2zm-13.4-.3l.4-1.8c.1 0 .2.1.2.1.7.3 1.4.5 2.1.4.2 0 .5-.1.7-.2.5-.2.5-.7.1-1.1-.2-.2-.5-.3-.8-.5-.4-.2-.8-.4-1.1-.7-1.2-1-.8-2.4-.1-3.1.6-.4.9-.8 1.7-.8 1.2 0 2.5 0 3.1.2h.1c-.1.6-.2 1.1-.4 1.7-.5-.2-1-.4-1.5-.4-.3 0-.6 0-.9.1-.2 0-.3.1-.4.2-.2.2-.2.5 0 .7l.5.4c.4.2.8.4 1.1.6.5.3 1 .8 1.1 1.4.2.9-.1 1.7-.9 2.3-.5.4-.7.6-1.4.6-1.4 0-2.5.1-3.4-.2-.1.2-.1.2-.2.1zm-3.5.3c.1-.7.1-.7.2-1 .5-2.2 1-4.5 1.4-6.7.1-.2.1-.3.3-.3H18c-.2 1.2-.4 2.1-.7 3.2-.3 1.5-.6 3-1 4.5 0 .2-.1.2-.3.2M5 8.2c0-.1.2-.2.3-.2h3.4c.5 0 .9.3 1 .8l.9 4.4c0 .1 0 .1.1.2 0-.1.1-.1.1-.1l2.1-5.1c-.1-.1 0-.2.1-.2h2.1c0 .1 0 .1-.1.2l-3.1 7.3c-.1.2-.1.3-.2.4-.1.1-.3 0-.5 0H9.7c-.1 0-.2 0-.2-.2L7.9 9.5c-.2-.2-.5-.5-.9-.6-.6-.3-1.7-.5-1.9-.5L5 8.2z" fill="#142688"></path></svg>
                    </div>
                    <Image
                        src={`/yape.webp`}
                        width={36}
                ...
                <div className="text-center text-xs text-gray-500 space-x-2">
                    ...
                    <span>&</span>
                    <a href="#" className="hover:text-gray-700">Política de Copyright</a>
                    <span>.</span>
